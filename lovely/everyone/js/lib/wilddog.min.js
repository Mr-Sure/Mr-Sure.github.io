...
function Xg(a,b,c){var d={cancel:null,context:null};if(b&&c)d.cancel=b,N(a,3,d.cancel,!0),d.context=c,zb(a,4,d.context);else if(b)if("object"===typeof b&&null!==b)d.context=b;else if("function"===typeof b)d.cancel=b;else throw Error(M(a,3,!0)+" must either be a cancel callback or a context object.");return d};var Zg={},$g=null;"undefined"!=typeof require?$g=require("engine.io-client"):$g=eio;function ah(a,b,c,d,e){this.id=a;this.A=nd("c:"+this.id+":");this.lc=c;this.Sb=d;this.sa=e;this.J=b;this.hb=0;this.A("Connection created");this.Ga=bh(this);this.Ga.on("open",ch(this));this.Ga.on("error",dh(this))}function ch(a){return function(){a.Ga.on("message",eh(a));a.Ga.on("close",fh(a))}}
